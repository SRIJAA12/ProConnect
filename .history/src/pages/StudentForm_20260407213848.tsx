  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 1: // Parent Details
        // Validate Mother
        if (!mother.status) {
          setError('Please select mother status (Alive/Nil/Deceased)');
          return false;
        }
        ...
        // Validate Father
        if (!father.status) {
          setError('Please select father status (Alive/Nil/Deceased)');
          return false;
        }
        ...
        if (hasGuardian && guardian) {
          if (!guardian.status) {
            setError('Please select guardian status');
            return false;
          }
          if (guardian.status === 'alive') {
  ...
  const renderParentDetails = () => {
      ...
      <div className="parent-section">
        ...
        <div className="form-group">
          ...
          <select
            ...
            value={parent.status}
            onChange={(e) =>
              setParent({ ...parent, status: e.target.value as 'alive' | 'nil' | 'deceased' })
            }
            required
          >
            <option value="">Select Status</option>
            <option value="alive">Alive</option>
            <option value="nil">Not Applicable (NIL)</option>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => setParent({ ...parent, contactNumber: e.target.value })}
                  required
                />
              </div>
    ...
    return (
      <div className="form-section">
        ...
        {renderParentFormSection(mother, setMother, "Mother's Details")}
        {renderParentFormSection(father, setFather, "Father's Details")}
        ...
        {hasGuardian && guardian && renderParentFormSection(guardian, setGuardian, "Guardian's Details")}
      </div>
    );
  };
